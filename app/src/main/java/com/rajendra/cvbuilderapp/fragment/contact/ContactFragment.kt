package com.rajendra.cvbuilderapp.fragment.contact
...
import com.rajendra.cvbuilderapp.MyWebActivity
...
class ContactFragment : Fragment(R.layout.fragment_contact), OnClickListener {
    ...
    private fun onMobileClicked() {
        val intent = Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "+16418192261"))
    ...
    private fun sendEmail() {
        ...
        if (isAppInstalled) {
            ...
            myIntent.putExtra(Intent.EXTRA_SUBJECT, "Hello Rajendra")
